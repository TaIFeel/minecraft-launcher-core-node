# Class DownloadForgeInstallerTask
...
```ts
new DownloadForgeInstallerTask(forgeVersion: string, installer: undefined | Object, minecraft: MinecraftFolder, options: InstallForgeOptions): DownloadForgeInstallerTask
```
#### Parameters

- **forgeVersion**: `string`
- **installer**: `undefined | Object`
- **minecraft**: `MinecraftFolder`
- **options**: `InstallForgeOptions`
#### Return Type

- `DownloadForgeInstallerTask`

<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/forge.ts#L147" target="_blank" rel="noreferrer">packages/installer/forge.ts:147</a>
</p>
...
```
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/forge.ts#L145" target="_blank" rel="noreferrer">packages/installer/forge.ts:145</a>
</p>
...
```ts
map(transform: Transform<DownloadForgeInstallerTask, N>): Task<N>
```
#### Parameters

- **transform**: `Transform<DownloadForgeInstallerTask, N>`
#### Return Type
...
```ts
setName(name: string, param: object): DownloadForgeInstallerTask
```
#### Parameters
