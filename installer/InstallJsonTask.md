...
```ts
new InstallJsonTask(version: MinecraftVersionBaseInfo, minecraft: MinecraftLocation, options: Options): InstallJsonTask
```
#### Parameters
...
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/minecraft.ts#L397" target="_blank" rel="noreferrer">packages/installer/minecraft.ts:397</a>
</p>
...
```ts
map(transform: Transform<InstallJsonTask, N>): Task<N>
```
#### Parameters
