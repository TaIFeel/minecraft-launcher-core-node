...
```ts
new InstallAssetIndexTask(version: ResolvedVersion & Object, options: AssetsOptions= {}): InstallAssetIndexTask
```
#### Parameters
...
- `InstallAssetIndexTask`

<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/minecraft.ts#L447" target="_blank" rel="noreferrer">packages/installer/minecraft.ts:447</a>
</p>
...
```ts
map(transform: Transform<InstallAssetIndexTask, N>): Task<N>
```
#### Parameters

- **transform**: `Transform<InstallAssetIndexTask, N>`
#### Return Type
...
```ts
setName(name: string, param: object): InstallAssetIndexTask
```
#### Parameters
