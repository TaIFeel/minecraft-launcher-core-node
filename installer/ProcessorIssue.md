...
The processor
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/diagnose.ts#L15" target="_blank" rel="noreferrer">packages/installer/diagnose.ts:15</a>
</p>
...
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/diagnose.ts#L10" target="_blank" rel="noreferrer">packages/installer/diagnose.ts:10</a>
</p>
